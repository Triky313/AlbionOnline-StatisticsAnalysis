...
public class TreasureControllerTests
{
    ...
    public void GetRarity_ReturnsExpectedValues()
    {
        ...
        var valuesToTest = new List<Tuple<string, TreasureRarity>>
        {
            ...
            Tuple.Create("SOME_STANDARD", TreasureRarity.Standard),
            Tuple.Create("SOME_STANDARD_T5", TreasureRarity.Standard),
            Tuple.Create("SOME_STANDARD_STANDARD_T7", TreasureRarity.Standard),
            Tuple.Create("STATIC_SOME_POI", TreasureRarity.Standard),
