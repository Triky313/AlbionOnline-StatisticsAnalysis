    ...
    : BaseViewModel
{
    ...
    public bool HasPatchNotes
    {
        get;
    } = hasPatchNotes;

    public ObservableCollection<UpdateReleaseNoteGroupViewModel> ReleaseNoteGroups
    {
        get;
    } = releaseNoteGroups ?? [];
    ...
    {
        get;
    } = postponeButtonText ?? string.Empty;
...
public sealed class UpdateReleaseNoteGroupViewModel(
    string title,
    string versionText,
    string releaseDateText,
    ObservableCollection<UpdateNoteSectionViewModel> sections)
{
    ...
    public ObservableCollection<UpdateNoteSectionViewModel> Sections
    {
        get;
    } = sections ?? [];
}
