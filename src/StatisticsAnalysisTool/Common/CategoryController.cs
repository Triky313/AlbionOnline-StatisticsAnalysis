...
{
    public static readonly List<CategoryObject> SubCategories =
    [
    ...
    public static ShopSubCategory ShopSubCategoryStringToShopSubCategory2(string value)
    {
        return SubCategories?.FirstOrDefault(x => x.CategoryId == value)?.ShopSubCategory2 ?? ShopSubCategory.Unknown;
    }
    ...
    {
        return Categories.GetValueOrDefault(shopCategory, "unknown");
    }

    public static string GetSubCategoryName(ShopSubCategory shopSubCategory)
    {
        return SubCategoryNames.GetValueOrDefault(shopSubCategory);
    }

    public static string GetCategoryName(ShopCategory shopCategory)
    {
        return CategoryNames.GetValueOrDefault(shopCategory);
    }
