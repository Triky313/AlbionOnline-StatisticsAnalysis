...
public enum EventCodes
{
    ...
    NewDynamicCompound,
    NewDynamicTileComposition,
    DestroyDynamicTileComposition,
    ...
    DragonIncursionClusterState,
    NotifyPlatformAccountConfirmed,
    DragonAreaMainQuestStateUpdateBase,
    DragonAreaPlayerJoinedInfo,
    DragonAreaMainQuestStateUpdate,
    DebugTriggerDragonAreaShutdownStart,
    BleedOut,
    NewDragonAreaEntrance,
    NewDragonAreaExit,
    DragonAreaExitStatusUpdate,
    UpdateDragonEnergy,
    DragonAreaTeleporterKeyUpdate,
    UsingDragonAreaEntranceStateUpdate,
    DragonAreaEntranceBindingStateUpdate,
    FactionTraderZoneBuffFailure,
    SmartClusterQueueContingentEntered,
    NewCorpseObject,
    ClusterSyncedStringValueUpdate,
    ClusterSyncedBoolValueUpdate,
    ClusterSyncedIntValueUpdate,
    ClusterSyncedStringValuesSnapshot,
    ClusterSyncedBoolValuesSnapshot,
    ClusterSyncedIntValuesSnapshot,
    FixedRotationForcedMovementPositionUpdate
}