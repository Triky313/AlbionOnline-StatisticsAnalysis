...
public class Item
{
    ...
    [JsonIgnore]
    public string AverageEstQualityValueString => Utilities.MarketPriceWithCulture(EstimatedMarketValueController.CalculateNearestToAverage(EstimatedMarketValues).MarketValue.IntegerValue);
    [JsonIgnore]
