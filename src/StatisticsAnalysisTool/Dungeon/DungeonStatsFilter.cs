...
public sealed class DungeonStatsFilter : BaseViewModel
{
    ...
    public static string TranslationAva => LocalizationController.Translation("AVA");
    public static string TranslationAvalonianDungeon => LocalizationController.Translation("AVALONIAN_DUNGEON");
    public static string TranslationHg => LocalizationController.Translation("HG");
    ...
    public static string TranslationCorruptedDungeon => LocalizationController.Translation("CORRUPTED_LAIR");
    public static string TranslationExped => LocalizationController.Translation("EXPED");
    ...
    public static string TranslationT1 => LocalizationController.Translation("T1");
    public static string TranslationT2 => LocalizationController.Translation("T2");
    public static string TranslationT3 => LocalizationController.Translation("T3");
    public static string TranslationT4 => LocalizationController.Translation("T4");
    public static string TranslationT5 => LocalizationController.Translation("T5");
    public static string TranslationT6 => LocalizationController.Translation("T6");
    public static string TranslationT7 => LocalizationController.Translation("T7");
    public static string TranslationT8 => LocalizationController.Translation("T8");
    public static string TranslationFlat => LocalizationController.Translation("Flat");
    public static string TranslationLevelPoint0 => LocalizationController.Translation("LevelPoint0");
    public static string TranslationLevelPoint1 => LocalizationController.Translation("LevelPoint1");
    public static string TranslationLevelPoint2 => LocalizationController.Translation("LevelPoint2");
    public static string TranslationLevelPoint3 => LocalizationController.Translation("LevelPoint3");
}