...
namespace StatisticsAnalysisTool.Avalonia.Settings.UserSettings;
...
public class SettingsController
{
    ...
    public static void SetWindowSettings(WindowState windowState, double height, double width, PixelPoint position)
    {
        if (windowState != WindowState.Maximized)
        {
            ...
            CurrentSettings.MainWindowPosition = position;
        }
